            ...
            <!-- <c:forEach var="b" items="${boardList}" varStatus="stat">
              ...
              <div class="list-group-item d-flex justify-content-between align-items-center px-0">
                ...
                <a class="btn btn-sm btn-outline-secondary"
                   href="${cpath}/article/listArticle.do?bid=${b.bid}">
                   게시물목록
                </a>
              </div>
              </c:if>
              ...
              <li class="list-group-item d-flex justify-content-between align-items-center">
                <div class="me-3 text-truncate" style="max-width: 70%;">
                  <c:if test="${not empty article.bname}">
                    <small class="text-muted"> [${article.bname}]</small>
                  </c:if>&nbsp;                
                   <a href="/article/getArticle.do?aid=${article.aid}&bid=${article.bid}&currPageNum=1">${article.atitle}</a>
                </div>
